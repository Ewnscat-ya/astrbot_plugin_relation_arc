...
| 虚拟环境 + astrbot 4.28.0 | `python -m unittest discover -s tests` | **272/272 通过**（56.6s） |
| 虚拟环境 + astrbot 4.26.0（声明下限） | 同上 | **272/272 通过**（53.1s） |
...
3. 在仓库目录运行：`python -m unittest discover -s tests -v` → 应为 `Ran 272 tests ... OK`。
